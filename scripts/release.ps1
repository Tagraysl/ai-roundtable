...
foreach ($entry in @('release.ps1','verify-release.cjs','Create-Desktop-Shortcut.ps1','Create-Desktop-Shortcut.cmd')) { Copy-Item -LiteralPath (Join-Path $PSScriptRoot $entry) -Destination (Join-Path $source 'scripts') }
